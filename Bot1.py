...
# Wrapper to add required prefixes for e5-small-v2
class EmbeddingsWrapper:
    ...
    def embed_documents(self, docs):
        ...
        return self.model.encode(passages, show_progress_bar=True).tolist()
    ...
    def __call__(self, docs):
        # fallback (not typically used for queries in LangChain)
        return self.embed_documents(docs)

# Initialize the E5 model
sentence_transformer_model = SentenceTransformer('intfloat/e5-small-v2')
